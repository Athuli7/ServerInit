...
echo "mysql-server mysql-server/root_password select $MySQLrootpassword" | debconf-set-selections
echo "mysql-server mysql-server/root_password_again select $MySQLrootpassword" | debconf-set-selections
